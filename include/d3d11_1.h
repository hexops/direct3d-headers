/*** Autogenerated by WIDL 5.0 from ./d3d11_1.idl - Do not edit ***/
...
ID3D11VideoContext1 : public ID3D11VideoContext
{
    virtual HRESULT STDMETHODCALLTYPE SubmitDecoderBuffers1(
        ...
        UINT NumBuffers,
        const D3D11_VIDEO_DECODER_BUFFER_DESC1 *pBufferDesc) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE CheckCryptoSessionStatus(
        ID3D11CryptoSession *pCryptoSession,
        D3D11_CRYPTO_SESSION_STATUS *pStatus) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE DecoderUpdateDownsampling(
        ID3D11VideoDecoder *pDecoder,
        const D3D11_VIDEO_SAMPLE_DESC *pOutputDesc) = 0;
    ...
    virtual void STDMETHODCALLTYPE VideoProcessorGetOutputColorSpace1(
        ID3D11VideoProcessor *pVideoProcessor,
        DXGI_COLOR_SPACE_TYPE *pColorSpace) = 0;
...
/*** ID3D11VideoContext methods ***/
#define ID3D11VideoContext1_GetDecoderBuffer(This,pDecoder,Type,pBufferSize,ppBuffer) (This)->lpVtbl->GetDecoderBuffer(This,pDecoder,Type,pBufferSize,ppBuffer)
#define ID3D11VideoContext1_ReleaseDecoderBuffer(This,pDecoder,Type) (This)->lpVtbl->ReleaseDecoderBuffer(This,pDecoder,Type)
#define ID3D11VideoContext1_DecoderBeginFrame(This,pDecoder,pView,ContentKeySize,pContentKey) (This)->lpVtbl->DecoderBeginFrame(This,pDecoder,pView,ContentKeySize,pContentKey)
#define ID3D11VideoContext1_DecoderEndFrame(This,pDecoder) (This)->lpVtbl->DecoderEndFrame(This,pDecoder)
#define ID3D11VideoContext1_SubmitDecoderBuffers(This,pDecoder,NumBuffers,pBufferDesc) (This)->lpVtbl->SubmitDecoderBuffers(This,pDecoder,NumBuffers,pBufferDesc)
#define ID3D11VideoContext1_DecoderExtension(This,pDecoder,pExtensionData) (This)->lpVtbl->DecoderExtension(This,pDecoder,pExtensionData)
#define ID3D11VideoContext1_VideoProcessorSetOutputTargetRect(This,pVideoProcessor,Enable,pRect) (This)->lpVtbl->VideoProcessorSetOutputTargetRect(This,pVideoProcessor,Enable,pRect)
#define ID3D11VideoContext1_VideoProcessorSetOutputBackgroundColor(This,pVideoProcessor,YCbCr,pColor) (This)->lpVtbl->VideoProcessorSetOutputBackgroundColor(This,pVideoProcessor,YCbCr,pColor)
#define ID3D11VideoContext1_VideoProcessorSetOutputColorSpace(This,pVideoProcessor,pColorSpace) (This)->lpVtbl->VideoProcessorSetOutputColorSpace(This,pVideoProcessor,pColorSpace)
#define ID3D11VideoContext1_VideoProcessorSetOutputAlphaFillMode(This,pVideoProcessor,AlphaFillMode,StreamIndex) (This)->lpVtbl->VideoProcessorSetOutputAlphaFillMode(This,pVideoProcessor,AlphaFillMode,StreamIndex)
#define ID3D11VideoContext1_VideoProcessorSetOutputConstriction(This,pVideoProcessor,Enable,Size) (This)->lpVtbl->VideoProcessorSetOutputConstriction(This,pVideoProcessor,Enable,Size)
#define ID3D11VideoContext1_VideoProcessorSetOutputStereoMode(This,pVideoProcessor,Enable) (This)->lpVtbl->VideoProcessorSetOutputStereoMode(This,pVideoProcessor,Enable)
#define ID3D11VideoContext1_VideoProcessorSetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorSetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext1_VideoProcessorGetOutputTargetRect(This,pVideoProcessor,Enabled,pRect) (This)->lpVtbl->VideoProcessorGetOutputTargetRect(This,pVideoProcessor,Enabled,pRect)
#define ID3D11VideoContext1_VideoProcessorGetOutputBackgroundColor(This,pVideoProcessor,pYCbCr,pColor) (This)->lpVtbl->VideoProcessorGetOutputBackgroundColor(This,pVideoProcessor,pYCbCr,pColor)
#define ID3D11VideoContext1_VideoProcessorGetOutputColorSpace(This,pVideoProcessor,pColorSpace) (This)->lpVtbl->VideoProcessorGetOutputColorSpace(This,pVideoProcessor,pColorSpace)
#define ID3D11VideoContext1_VideoProcessorGetOutputAlphaFillMode(This,pVideoProcessor,pAlphaFillMode,pStreamIndex) (This)->lpVtbl->VideoProcessorGetOutputAlphaFillMode(This,pVideoProcessor,pAlphaFillMode,pStreamIndex)
#define ID3D11VideoContext1_VideoProcessorGetOutputConstriction(This,pVideoProcessor,pEnabled,pSize) (This)->lpVtbl->VideoProcessorGetOutputConstriction(This,pVideoProcessor,pEnabled,pSize)
#define ID3D11VideoContext1_VideoProcessorGetOutputStereoMode(This,pVideoProcessor,pEnabled) (This)->lpVtbl->VideoProcessorGetOutputStereoMode(This,pVideoProcessor,pEnabled)
#define ID3D11VideoContext1_VideoProcessorGetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorGetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext1_VideoProcessorSetStreamFrameFormat(This,pVideoProcessor,StreamIndex,FrameFormat) (This)->lpVtbl->VideoProcessorSetStreamFrameFormat(This,pVideoProcessor,StreamIndex,FrameFormat)
#define ID3D11VideoContext1_VideoProcessorSetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace) (This)->lpVtbl->VideoProcessorSetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace)
#define ID3D11VideoContext1_VideoProcessorSetStreamOutputRate(This,pVideoProcessor,StreamIndex,OutputRate,RepeatFrame,pCustomRate) (This)->lpVtbl->VideoProcessorSetStreamOutputRate(This,pVideoProcessor,StreamIndex,OutputRate,RepeatFrame,pCustomRate)
#define ID3D11VideoContext1_VideoProcessorSetStreamSourceRect(This,pVideoProcessor,StreamIndex,Enable,pRect) (This)->lpVtbl->VideoProcessorSetStreamSourceRect(This,pVideoProcessor,StreamIndex,Enable,pRect)
#define ID3D11VideoContext1_VideoProcessorSetStreamDestRect(This,pVideoProcessor,StreamIndex,Enable,pRect) (This)->lpVtbl->VideoProcessorSetStreamDestRect(This,pVideoProcessor,StreamIndex,Enable,pRect)
#define ID3D11VideoContext1_VideoProcessorSetStreamAlpha(This,pVideoProcessor,StreamIndex,Enable,Alpha) (This)->lpVtbl->VideoProcessorSetStreamAlpha(This,pVideoProcessor,StreamIndex,Enable,Alpha)
#define ID3D11VideoContext1_VideoProcessorSetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries) (This)->lpVtbl->VideoProcessorSetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries)
#define ID3D11VideoContext1_VideoProcessorSetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,Enable,pSourceAspectRatio,pDestinationAspectRatio) (This)->lpVtbl->VideoProcessorSetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,Enable,pSourceAspectRatio,pDestinationAspectRatio)
#define ID3D11VideoContext1_VideoProcessorSetStreamLumaKey(This,pVideoProcessor,StreamIndex,Enable,Lower,Upper) (This)->lpVtbl->VideoProcessorSetStreamLumaKey(This,pVideoProcessor,StreamIndex,Enable,Lower,Upper)
...
#define ID3D11VideoContext1_VideoProcessorSetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,Enable) (This)->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,Enable)
#define ID3D11VideoContext1_VideoProcessorSetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,Enable,Level) (This)->lpVtbl->VideoProcessorSetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,Enable,Level)
#define ID3D11VideoContext1_VideoProcessorSetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorSetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext1_VideoProcessorGetStreamFrameFormat(This,pVideoProcessor,StreamIndex,pFrameFormat) (This)->lpVtbl->VideoProcessorGetStreamFrameFormat(This,pVideoProcessor,StreamIndex,pFrameFormat)
#define ID3D11VideoContext1_VideoProcessorGetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace) (This)->lpVtbl->VideoProcessorGetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace)
#define ID3D11VideoContext1_VideoProcessorGetStreamOutputRate(This,pVideoProcessor,StreamIndex,pOutputRate,pRepeatFrame,pCustomRate) (This)->lpVtbl->VideoProcessorGetStreamOutputRate(This,pVideoProcessor,StreamIndex,pOutputRate,pRepeatFrame,pCustomRate)
#define ID3D11VideoContext1_VideoProcessorGetStreamSourceRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect) (This)->lpVtbl->VideoProcessorGetStreamSourceRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect)
#define ID3D11VideoContext1_VideoProcessorGetStreamDestRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect) (This)->lpVtbl->VideoProcessorGetStreamDestRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect)
#define ID3D11VideoContext1_VideoProcessorGetStreamAlpha(This,pVideoProcessor,StreamIndex,pEnabled,pAlpha) (This)->lpVtbl->VideoProcessorGetStreamAlpha(This,pVideoProcessor,StreamIndex,pEnabled,pAlpha)
#define ID3D11VideoContext1_VideoProcessorGetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries) (This)->lpVtbl->VideoProcessorGetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries)
#define ID3D11VideoContext1_VideoProcessorGetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,pEnabled,pSourceAspectRatio,pDestinationAspectRatio) (This)->lpVtbl->VideoProcessorGetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,pEnabled,pSourceAspectRatio,pDestinationAspectRatio)
#define ID3D11VideoContext1_VideoProcessorGetStreamLumaKey(This,pVideoProcessor,StreamIndex,pEnabled,pLower,pUpper) (This)->lpVtbl->VideoProcessorGetStreamLumaKey(This,pVideoProcessor,StreamIndex,pEnabled,pLower,pUpper)
#define ID3D11VideoContext1_VideoProcessorGetStreamStereoFormat(This,pVideoProcessor,StreamIndex,pEnable,pFormat,pLeftViewFrame0,pBaseViewFrame0,pFlipMode,MonoOffset) (This)->lpVtbl->VideoProcessorGetStreamStereoFormat(This,pVideoProcessor,StreamIndex,pEnable,pFormat,pLeftViewFrame0,pBaseViewFrame0,pFlipMode,MonoOffset)
#define ID3D11VideoContext1_VideoProcessorGetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,pEnabled) (This)->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,pEnabled)
#define ID3D11VideoContext1_VideoProcessorGetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,pEnabled,pLevel) (This)->lpVtbl->VideoProcessorGetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,pEnabled,pLevel)
#define ID3D11VideoContext1_VideoProcessorGetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorGetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext1_VideoProcessorBlt(This,pVideoProcessor,pView,OutputFrame,StreamCount,pStreams) (This)->lpVtbl->VideoProcessorBlt(This,pVideoProcessor,pView,OutputFrame,StreamCount,pStreams)
#define ID3D11VideoContext1_NegotiateCryptoSessionKeyExchange(This,pCryptoSession,DataSize,pData) (This)->lpVtbl->NegotiateCryptoSessionKeyExchange(This,pCryptoSession,DataSize,pData)
#define ID3D11VideoContext1_EncryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,IVSize,pIV) (This)->lpVtbl->EncryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,IVSize,pIV)
#define ID3D11VideoContext1_DecryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,pEncryptedBlockInfo,ContentKeySize,pContentKey,IVSize,pIV) (This)->lpVtbl->DecryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,pEncryptedBlockInfo,ContentKeySize,pContentKey,IVSize,pIV)
#define ID3D11VideoContext1_StartSessionKeyRefresh(This,pCryptoSession,RandomNumberSize,pRandomNumber) (This)->lpVtbl->StartSessionKeyRefresh(This,pCryptoSession,RandomNumberSize,pRandomNumber)
#define ID3D11VideoContext1_FinishSessionKeyRefresh(This,pCryptoSession) (This)->lpVtbl->FinishSessionKeyRefresh(This,pCryptoSession)
#define ID3D11VideoContext1_GetEncryptionBltKey(This,pCryptoSession,KeySize,pReadbackKey) (This)->lpVtbl->GetEncryptionBltKey(This,pCryptoSession,KeySize,pReadbackKey)
#define ID3D11VideoContext1_NegotiateAuthenticatedChannelKeyExchange(This,pChannel,DataSize,pData) (This)->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This,pChannel,DataSize,pData)
#define ID3D11VideoContext1_QueryAuthenticatedChannel(This,pChannel,InputSize,pInput,OutputSize,pOutput) (This)->lpVtbl->QueryAuthenticatedChannel(This,pChannel,InputSize,pInput,OutputSize,pOutput)
#define ID3D11VideoContext1_ConfigureAuthenticatedChannel(This,pChannel,InputSize,pInput,pOutput) (This)->lpVtbl->ConfigureAuthenticatedChannel(This,pChannel,InputSize,pInput,pOutput)
#define ID3D11VideoContext1_VideoProcessorSetStreamRotation(This,pVideoProcessor,StreamIndex,Enable,Rotation) (This)->lpVtbl->VideoProcessorSetStreamRotation(This,pVideoProcessor,StreamIndex,Enable,Rotation)
#define ID3D11VideoContext1_VideoProcessorGetStreamRotation(This,pVideoProcessor,StreamIndex,pEnable,pRotation) (This)->lpVtbl->VideoProcessorGetStreamRotation(This,pVideoProcessor,StreamIndex,pEnable,pRotation)
/*** ID3D11VideoContext1 methods ***/
#define ID3D11VideoContext1_SubmitDecoderBuffers1(This,pDecoder,NumBuffers,pBufferDesc) (This)->lpVtbl->SubmitDecoderBuffers1(This,pDecoder,NumBuffers,pBufferDesc)
#define ID3D11VideoContext1_GetDataForNewHardwareKey(This,pCryptoSession,PrivateInputSize,pPrivatInputData,pPrivateOutputData) (This)->lpVtbl->GetDataForNewHardwareKey(This,pCryptoSession,PrivateInputSize,pPrivatInputData,pPrivateOutputData)
#define ID3D11VideoContext1_CheckCryptoSessionStatus(This,pCryptoSession,pStatus) (This)->lpVtbl->CheckCryptoSessionStatus(This,pCryptoSession,pStatus)
#define ID3D11VideoContext1_DecoderEnableDownsampling(This,pDecoder,InputColorSpace,pOutputDesc,ReferenceFrameCount) (This)->lpVtbl->DecoderEnableDownsampling(This,pDecoder,InputColorSpace,pOutputDesc,ReferenceFrameCount)
#define ID3D11VideoContext1_DecoderUpdateDownsampling(This,pDecoder,pOutputDesc) (This)->lpVtbl->DecoderUpdateDownsampling(This,pDecoder,pOutputDesc)
#define ID3D11VideoContext1_VideoProcessorSetOutputColorSpace1(This,pVideoProcessor,ColorSpace) (This)->lpVtbl->VideoProcessorSetOutputColorSpace1(This,pVideoProcessor,ColorSpace)
#define ID3D11VideoContext1_VideoProcessorSetOutputShaderUsage(This,pVideoProcessor,ShaderUsage) (This)->lpVtbl->VideoProcessorSetOutputShaderUsage(This,pVideoProcessor,ShaderUsage)
#define ID3D11VideoContext1_VideoProcessorGetOutputColorSpace1(This,pVideoProcessor,pColorSpace) (This)->lpVtbl->VideoProcessorGetOutputColorSpace1(This,pVideoProcessor,pColorSpace)
#define ID3D11VideoContext1_VideoProcessorGetOutputShaderUsage(This,pVideoProcessor,pShaderUsage) (This)->lpVtbl->VideoProcessorGetOutputShaderUsage(This,pVideoProcessor,pShaderUsage)
#define ID3D11VideoContext1_VideoProcessorSetStreamColorSpace1(This,pVideoProcessor,StreamIndex,ColorSpace) (This)->lpVtbl->VideoProcessorSetStreamColorSpace1(This,pVideoProcessor,StreamIndex,ColorSpace)
#define ID3D11VideoContext1_VideoProcessorSetStreamMirror(This,pVideoProcessor,StreamIndex,Enable,FlipHorizontal,FlipVertical) (This)->lpVtbl->VideoProcessorSetStreamMirror(This,pVideoProcessor,StreamIndex,Enable,FlipHorizontal,FlipVertical)
#define ID3D11VideoContext1_VideoProcessorGetStreamColorSpace1(This,pVideoProcessor,StreamIndex,pColorSpace) (This)->lpVtbl->VideoProcessorGetStreamColorSpace1(This,pVideoProcessor,StreamIndex,pColorSpace)
#define ID3D11VideoContext1_VideoProcessorGetStreamMirror(This,pVideoProcessor,StreamIndex,pEnable,pFlipHorizontal,pFlipVertical) (This)->lpVtbl->VideoProcessorGetStreamMirror(This,pVideoProcessor,StreamIndex,pEnable,pFlipHorizontal,pFlipVertical)
#define ID3D11VideoContext1_VideoProcessorGetBehaviorHints(This,pVideoProcessor,OutputWidth,OutputHeight,OutputFormat,StreamCount,pStreams,pBehaviorHints) (This)->lpVtbl->VideoProcessorGetBehaviorHints(This,pVideoProcessor,OutputWidth,OutputHeight,OutputFormat,StreamCount,pStreams,pBehaviorHints)
#else
/*** IUnknown methods ***/
...
/*** ID3D11VideoContext methods ***/
static FORCEINLINE HRESULT ID3D11VideoContext1_GetDecoderBuffer(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,D3D11_VIDEO_DECODER_BUFFER_TYPE Type,UINT *pBufferSize,void **ppBuffer) {
    return This->lpVtbl->GetDecoderBuffer(This,pDecoder,Type,pBufferSize,ppBuffer);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_ReleaseDecoderBuffer(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,D3D11_VIDEO_DECODER_BUFFER_TYPE Type) {
    return This->lpVtbl->ReleaseDecoderBuffer(This,pDecoder,Type);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_DecoderBeginFrame(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,ID3D11VideoDecoderOutputView *pView,UINT ContentKeySize,const void *pContentKey) {
    return This->lpVtbl->DecoderBeginFrame(This,pDecoder,pView,ContentKeySize,pContentKey);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_DecoderEndFrame(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder) {
    return This->lpVtbl->DecoderEndFrame(This,pDecoder);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_SubmitDecoderBuffers(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,UINT NumBuffers,const D3D11_VIDEO_DECODER_BUFFER_DESC *pBufferDesc) {
    return This->lpVtbl->SubmitDecoderBuffers(This,pDecoder,NumBuffers,pBufferDesc);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext1_DecoderExtension(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,const D3D11_VIDEO_DECODER_EXTENSION *pExtensionData) {
    return This->lpVtbl->DecoderExtension(This,pDecoder,pExtensionData);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputTargetRect(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL Enable,const RECT *pRect) {
    This->lpVtbl->VideoProcessorSetOutputTargetRect(This,pVideoProcessor,Enable,pRect);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputBackgroundColor(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL YCbCr,const D3D11_VIDEO_COLOR *pColor) {
    This->lpVtbl->VideoProcessorSetOutputBackgroundColor(This,pVideoProcessor,YCbCr,pColor);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputColorSpace(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,const D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorSetOutputColorSpace(This,pVideoProcessor,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputAlphaFillMode(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE AlphaFillMode,UINT StreamIndex) {
    This->lpVtbl->VideoProcessorSetOutputAlphaFillMode(This,pVideoProcessor,AlphaFillMode,StreamIndex);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputConstriction(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL Enable,SIZE Size) {
    This->lpVtbl->VideoProcessorSetOutputConstriction(This,pVideoProcessor,Enable,Size);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputStereoMode(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL Enable) {
    This->lpVtbl->VideoProcessorSetOutputStereoMode(This,pVideoProcessor,Enable);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext1_VideoProcessorSetOutputExtension(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorSetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputTargetRect(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *Enabled,RECT *pRect) {
    This->lpVtbl->VideoProcessorGetOutputTargetRect(This,pVideoProcessor,Enabled,pRect);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputBackgroundColor(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pYCbCr,D3D11_VIDEO_COLOR *pColor) {
    This->lpVtbl->VideoProcessorGetOutputBackgroundColor(This,pVideoProcessor,pYCbCr,pColor);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputColorSpace(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorGetOutputColorSpace(This,pVideoProcessor,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputAlphaFillMode(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE *pAlphaFillMode,UINT *pStreamIndex) {
    This->lpVtbl->VideoProcessorGetOutputAlphaFillMode(This,pVideoProcessor,pAlphaFillMode,pStreamIndex);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputConstriction(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pEnabled,SIZE *pSize) {
    This->lpVtbl->VideoProcessorGetOutputConstriction(This,pVideoProcessor,pEnabled,pSize);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputStereoMode(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pEnabled) {
    This->lpVtbl->VideoProcessorGetOutputStereoMode(This,pVideoProcessor,pEnabled);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext1_VideoProcessorGetOutputExtension(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorGetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamFrameFormat(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_FRAME_FORMAT FrameFormat) {
    This->lpVtbl->VideoProcessorSetStreamFrameFormat(This,pVideoProcessor,StreamIndex,FrameFormat);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamColorSpace(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,const D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorSetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamOutputRate(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_OUTPUT_RATE OutputRate,BOOL RepeatFrame,const DXGI_RATIONAL *pCustomRate) {
    This->lpVtbl->VideoProcessorSetStreamOutputRate(This,pVideoProcessor,StreamIndex,OutputRate,RepeatFrame,pCustomRate);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamSourceRect(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,const RECT *pRect) {
    This->lpVtbl->VideoProcessorSetStreamSourceRect(This,pVideoProcessor,StreamIndex,Enable,pRect);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamDestRect(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,const RECT *pRect) {
    This->lpVtbl->VideoProcessorSetStreamDestRect(This,pVideoProcessor,StreamIndex,Enable,pRect);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamAlpha(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,FLOAT Alpha) {
    This->lpVtbl->VideoProcessorSetStreamAlpha(This,pVideoProcessor,StreamIndex,Enable,Alpha);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamPalette(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,UINT Count,const UINT *pEntries) {
    This->lpVtbl->VideoProcessorSetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamPixelAspectRatio(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,const DXGI_RATIONAL *pSourceAspectRatio,const DXGI_RATIONAL *pDestinationAspectRatio) {
...
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamLumaKey(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,FLOAT Lower,FLOAT Upper) {
    This->lpVtbl->VideoProcessorSetStreamLumaKey(This,pVideoProcessor,StreamIndex,Enable,Lower,Upper);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamStereoFormat(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,D3D11_VIDEO_PROCESSOR_STEREO_FORMAT Format,BOOL LeftViewFrame0,BOOL BaseViewFrame0,D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE FlipMode,int MonoOffset) {
...
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamAutoProcessingMode(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable) {
    This->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,Enable);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamFilter(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_FILTER Filter,BOOL Enable,int Level) {
    This->lpVtbl->VideoProcessorSetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,Enable,Level);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext1_VideoProcessorSetStreamExtension(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorSetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamFrameFormat(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_FRAME_FORMAT *pFrameFormat) {
    This->lpVtbl->VideoProcessorGetStreamFrameFormat(This,pVideoProcessor,StreamIndex,pFrameFormat);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamColorSpace(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorGetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamOutputRate(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_OUTPUT_RATE *pOutputRate,BOOL *pRepeatFrame,DXGI_RATIONAL *pCustomRate) {
    This->lpVtbl->VideoProcessorGetStreamOutputRate(This,pVideoProcessor,StreamIndex,pOutputRate,pRepeatFrame,pCustomRate);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamSourceRect(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,RECT *pRect) {
    This->lpVtbl->VideoProcessorGetStreamSourceRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamDestRect(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,RECT *pRect) {
    This->lpVtbl->VideoProcessorGetStreamDestRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamAlpha(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,FLOAT *pAlpha) {
    This->lpVtbl->VideoProcessorGetStreamAlpha(This,pVideoProcessor,StreamIndex,pEnabled,pAlpha);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamPalette(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,UINT Count,UINT *pEntries) {
    This->lpVtbl->VideoProcessorGetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamPixelAspectRatio(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,DXGI_RATIONAL *pSourceAspectRatio,DXGI_RATIONAL *pDestinationAspectRatio) {
...
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamLumaKey(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,FLOAT *pLower,FLOAT *pUpper) {
...
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamAutoProcessingMode(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled) {
    This->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,pEnabled);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamFilter(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_FILTER Filter,BOOL *pEnabled,int *pLevel) {
    This->lpVtbl->VideoProcessorGetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,pEnabled,pLevel);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext1_VideoProcessorGetStreamExtension(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorGetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_VideoProcessorBlt(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,ID3D11VideoProcessorOutputView *pView,UINT OutputFrame,UINT StreamCount,const D3D11_VIDEO_PROCESSOR_STREAM *pStreams) {
    return This->lpVtbl->VideoProcessorBlt(This,pVideoProcessor,pView,OutputFrame,StreamCount,pStreams);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_NegotiateCryptoSessionKeyExchange(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,UINT DataSize,void *pData) {
    return This->lpVtbl->NegotiateCryptoSessionKeyExchange(This,pCryptoSession,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext1_EncryptionBlt(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,ID3D11Texture2D *pSrcSurface,ID3D11Texture2D *pDstSurface,UINT IVSize,void *pIV) {
    This->lpVtbl->EncryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,IVSize,pIV);
}
static FORCEINLINE void ID3D11VideoContext1_DecryptionBlt(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,ID3D11Texture2D *pSrcSurface,ID3D11Texture2D *pDstSurface,D3D11_ENCRYPTED_BLOCK_INFO *pEncryptedBlockInfo,UINT ContentKeySize,const void *pContentKey,UINT IVSize,void *pIV) {
...
static FORCEINLINE void ID3D11VideoContext1_StartSessionKeyRefresh(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,UINT RandomNumberSize,void *pRandomNumber) {
    This->lpVtbl->StartSessionKeyRefresh(This,pCryptoSession,RandomNumberSize,pRandomNumber);
}
static FORCEINLINE void ID3D11VideoContext1_FinishSessionKeyRefresh(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession) {
    This->lpVtbl->FinishSessionKeyRefresh(This,pCryptoSession);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_GetEncryptionBltKey(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,UINT KeySize,void *pReadbackKey) {
    return This->lpVtbl->GetEncryptionBltKey(This,pCryptoSession,KeySize,pReadbackKey);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_NegotiateAuthenticatedChannelKeyExchange(ID3D11VideoContext1* This,ID3D11AuthenticatedChannel *pChannel,UINT DataSize,void *pData) {
    return This->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This,pChannel,DataSize,pData);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_QueryAuthenticatedChannel(ID3D11VideoContext1* This,ID3D11AuthenticatedChannel *pChannel,UINT InputSize,const void *pInput,UINT OutputSize,void *pOutput) {
    return This->lpVtbl->QueryAuthenticatedChannel(This,pChannel,InputSize,pInput,OutputSize,pOutput);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_ConfigureAuthenticatedChannel(ID3D11VideoContext1* This,ID3D11AuthenticatedChannel *pChannel,UINT InputSize,const void *pInput,D3D11_AUTHENTICATED_CONFIGURE_OUTPUT *pOutput) {
    return This->lpVtbl->ConfigureAuthenticatedChannel(This,pChannel,InputSize,pInput,pOutput);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamRotation(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,D3D11_VIDEO_PROCESSOR_ROTATION Rotation) {
    This->lpVtbl->VideoProcessorSetStreamRotation(This,pVideoProcessor,StreamIndex,Enable,Rotation);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamRotation(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnable,D3D11_VIDEO_PROCESSOR_ROTATION *pRotation) {
    This->lpVtbl->VideoProcessorGetStreamRotation(This,pVideoProcessor,StreamIndex,pEnable,pRotation);
}
/*** ID3D11VideoContext1 methods ***/
static FORCEINLINE HRESULT ID3D11VideoContext1_SubmitDecoderBuffers1(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,UINT NumBuffers,const D3D11_VIDEO_DECODER_BUFFER_DESC1 *pBufferDesc) {
    return This->lpVtbl->SubmitDecoderBuffers1(This,pDecoder,NumBuffers,pBufferDesc);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_GetDataForNewHardwareKey(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,UINT PrivateInputSize,const void *pPrivatInputData,UINT64 *pPrivateOutputData) {
    return This->lpVtbl->GetDataForNewHardwareKey(This,pCryptoSession,PrivateInputSize,pPrivatInputData,pPrivateOutputData);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_CheckCryptoSessionStatus(ID3D11VideoContext1* This,ID3D11CryptoSession *pCryptoSession,D3D11_CRYPTO_SESSION_STATUS *pStatus) {
    return This->lpVtbl->CheckCryptoSessionStatus(This,pCryptoSession,pStatus);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_DecoderEnableDownsampling(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,DXGI_COLOR_SPACE_TYPE InputColorSpace,const D3D11_VIDEO_SAMPLE_DESC *pOutputDesc,UINT ReferenceFrameCount) {
    return This->lpVtbl->DecoderEnableDownsampling(This,pDecoder,InputColorSpace,pOutputDesc,ReferenceFrameCount);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_DecoderUpdateDownsampling(ID3D11VideoContext1* This,ID3D11VideoDecoder *pDecoder,const D3D11_VIDEO_SAMPLE_DESC *pOutputDesc) {
    return This->lpVtbl->DecoderUpdateDownsampling(This,pDecoder,pOutputDesc);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputColorSpace1(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,DXGI_COLOR_SPACE_TYPE ColorSpace) {
    This->lpVtbl->VideoProcessorSetOutputColorSpace1(This,pVideoProcessor,ColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetOutputShaderUsage(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL ShaderUsage) {
    This->lpVtbl->VideoProcessorSetOutputShaderUsage(This,pVideoProcessor,ShaderUsage);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputColorSpace1(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,DXGI_COLOR_SPACE_TYPE *pColorSpace) {
    This->lpVtbl->VideoProcessorGetOutputColorSpace1(This,pVideoProcessor,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetOutputShaderUsage(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pShaderUsage) {
    This->lpVtbl->VideoProcessorGetOutputShaderUsage(This,pVideoProcessor,pShaderUsage);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamColorSpace1(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,DXGI_COLOR_SPACE_TYPE ColorSpace) {
    This->lpVtbl->VideoProcessorSetStreamColorSpace1(This,pVideoProcessor,StreamIndex,ColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorSetStreamMirror(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,BOOL FlipHorizontal,BOOL FlipVertical) {
    This->lpVtbl->VideoProcessorSetStreamMirror(This,pVideoProcessor,StreamIndex,Enable,FlipHorizontal,FlipVertical);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamColorSpace1(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,DXGI_COLOR_SPACE_TYPE *pColorSpace) {
    This->lpVtbl->VideoProcessorGetStreamColorSpace1(This,pVideoProcessor,StreamIndex,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext1_VideoProcessorGetStreamMirror(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnable,BOOL *pFlipHorizontal,BOOL *pFlipVertical) {
    This->lpVtbl->VideoProcessorGetStreamMirror(This,pVideoProcessor,StreamIndex,pEnable,pFlipHorizontal,pFlipVertical);
}
static FORCEINLINE HRESULT ID3D11VideoContext1_VideoProcessorGetBehaviorHints(ID3D11VideoContext1* This,ID3D11VideoProcessor *pVideoProcessor,UINT OutputWidth,UINT OutputHeight,DXGI_FORMAT OutputFormat,UINT StreamCount,const D3D11_VIDEO_PROCESSOR_STREAM_BEHAVIOR_HINT *pStreams,UINT *pBehaviorHints) {
...
ID3D11VideoDevice1 : public ID3D11VideoDevice
{
    ...
    virtual HRESULT STDMETHODCALLTYPE RecommendVideoDecoderDownsampleParameters(
        ...
        const D3D11_VIDEO_DECODER_CONFIG *pInputConfig,
        const DXGI_RATIONAL *pFrameRate,
        D3D11_VIDEO_SAMPLE_DESC *pRecommendedOutputDesc) = 0;
...
/*** ID3D11VideoDevice1 methods ***/
#define ID3D11VideoDevice1_GetCryptoSessionPrivateDataSize(This,pCryptoType,pDecoderProfile,pKeyExchangeType,pPrivateInputSize,pPrivateOutputSize) (This)->lpVtbl->GetCryptoSessionPrivateDataSize(This,pCryptoType,pDecoderProfile,pKeyExchangeType,pPrivateInputSize,pPrivateOutputSize)
#define ID3D11VideoDevice1_GetVideoDecoderCaps(This,pDecoderProfile,SampleWidth,SampleHeight,pFrameRate,BitRate,pCryptoType,pDecoderCaps) (This)->lpVtbl->GetVideoDecoderCaps(This,pDecoderProfile,SampleWidth,SampleHeight,pFrameRate,BitRate,pCryptoType,pDecoderCaps)
#define ID3D11VideoDevice1_CheckVideoDecoderDownsampling(This,pInputDesc,InputColorSpace,pInputConfig,pFrameRate,pOutputDesc,pSupported,pRealTimeHint) (This)->lpVtbl->CheckVideoDecoderDownsampling(This,pInputDesc,InputColorSpace,pInputConfig,pFrameRate,pOutputDesc,pSupported,pRealTimeHint)
#define ID3D11VideoDevice1_RecommendVideoDecoderDownsampleParameters(This,pInputDesc,InputColorSpace,pInputConfig,pFrameRate,pRecommendedOutputDesc) (This)->lpVtbl->RecommendVideoDecoderDownsampleParameters(This,pInputDesc,InputColorSpace,pInputConfig,pFrameRate,pRecommendedOutputDesc)
#else
/*** IUnknown methods ***/
...
/*** ID3D11VideoDevice1 methods ***/
static FORCEINLINE HRESULT ID3D11VideoDevice1_GetCryptoSessionPrivateDataSize(ID3D11VideoDevice1* This,const GUID *pCryptoType,const GUID *pDecoderProfile,const GUID *pKeyExchangeType,UINT *pPrivateInputSize,UINT *pPrivateOutputSize) {
...
static FORCEINLINE HRESULT ID3D11VideoDevice1_GetVideoDecoderCaps(ID3D11VideoDevice1* This,const GUID *pDecoderProfile,UINT SampleWidth,UINT SampleHeight,const DXGI_RATIONAL *pFrameRate,UINT BitRate,const GUID *pCryptoType,UINT *pDecoderCaps) {
...
static FORCEINLINE HRESULT ID3D11VideoDevice1_CheckVideoDecoderDownsampling(ID3D11VideoDevice1* This,const D3D11_VIDEO_DECODER_DESC *pInputDesc,DXGI_COLOR_SPACE_TYPE InputColorSpace,const D3D11_VIDEO_DECODER_CONFIG *pInputConfig,const DXGI_RATIONAL *pFrameRate,const D3D11_VIDEO_SAMPLE_DESC *pOutputDesc,BOOL *pSupported,BOOL *pRealTimeHint) {
...
static FORCEINLINE HRESULT ID3D11VideoDevice1_RecommendVideoDecoderDownsampleParameters(ID3D11VideoDevice1* This,const D3D11_VIDEO_DECODER_DESC *pInputDesc,DXGI_COLOR_SPACE_TYPE InputColorSpace,const D3D11_VIDEO_DECODER_CONFIG *pInputConfig,const DXGI_RATIONAL *pFrameRate,D3D11_VIDEO_SAMPLE_DESC *pRecommendedOutputDesc) {
...
/*** ID3D11VideoProcessorEnumerator1 methods ***/
#define ID3D11VideoProcessorEnumerator1_CheckVideoProcessorFormatConversion(This,InputFormat,InputColorSpace,OutputFormat,OutputColorSpace,pSupported) (This)->lpVtbl->CheckVideoProcessorFormatConversion(This,InputFormat,InputColorSpace,OutputFormat,OutputColorSpace,pSupported)
#else
/*** IUnknown methods ***/
...
/*** ID3D11VideoProcessorEnumerator1 methods ***/
static FORCEINLINE HRESULT ID3D11VideoProcessorEnumerator1_CheckVideoProcessorFormatConversion(ID3D11VideoProcessorEnumerator1* This,DXGI_FORMAT InputFormat,DXGI_COLOR_SPACE_TYPE InputColorSpace,DXGI_FORMAT OutputFormat,DXGI_COLOR_SPACE_TYPE OutputColorSpace,BOOL *pSupported) {
    return This->lpVtbl->CheckVideoProcessorFormatConversion(This,InputFormat,InputColorSpace,OutputFormat,OutputColorSpace,pSupported);
}
#endif
#endif
