/*** Autogenerated by WIDL 5.0 from ./d3d11.idl - Do not edit ***/
...
#define D3D11_PS_FRONTFACING_FALSE_VALUE (0x0)
...
/*** ID3D11VideoContext methods ***/
#define ID3D11VideoContext_GetDecoderBuffer(This,pDecoder,Type,pBufferSize,ppBuffer) (This)->lpVtbl->GetDecoderBuffer(This,pDecoder,Type,pBufferSize,ppBuffer)
#define ID3D11VideoContext_ReleaseDecoderBuffer(This,pDecoder,Type) (This)->lpVtbl->ReleaseDecoderBuffer(This,pDecoder,Type)
#define ID3D11VideoContext_DecoderBeginFrame(This,pDecoder,pView,ContentKeySize,pContentKey) (This)->lpVtbl->DecoderBeginFrame(This,pDecoder,pView,ContentKeySize,pContentKey)
...
#define ID3D11VideoContext_VideoProcessorSetOutputTargetRect(This,pVideoProcessor,Enable,pRect) (This)->lpVtbl->VideoProcessorSetOutputTargetRect(This,pVideoProcessor,Enable,pRect)
#define ID3D11VideoContext_VideoProcessorSetOutputBackgroundColor(This,pVideoProcessor,YCbCr,pColor) (This)->lpVtbl->VideoProcessorSetOutputBackgroundColor(This,pVideoProcessor,YCbCr,pColor)
#define ID3D11VideoContext_VideoProcessorSetOutputColorSpace(This,pVideoProcessor,pColorSpace) (This)->lpVtbl->VideoProcessorSetOutputColorSpace(This,pVideoProcessor,pColorSpace)
#define ID3D11VideoContext_VideoProcessorSetOutputAlphaFillMode(This,pVideoProcessor,AlphaFillMode,StreamIndex) (This)->lpVtbl->VideoProcessorSetOutputAlphaFillMode(This,pVideoProcessor,AlphaFillMode,StreamIndex)
#define ID3D11VideoContext_VideoProcessorSetOutputConstriction(This,pVideoProcessor,Enable,Size) (This)->lpVtbl->VideoProcessorSetOutputConstriction(This,pVideoProcessor,Enable,Size)
#define ID3D11VideoContext_VideoProcessorSetOutputStereoMode(This,pVideoProcessor,Enable) (This)->lpVtbl->VideoProcessorSetOutputStereoMode(This,pVideoProcessor,Enable)
#define ID3D11VideoContext_VideoProcessorSetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorSetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext_VideoProcessorGetOutputTargetRect(This,pVideoProcessor,Enabled,pRect) (This)->lpVtbl->VideoProcessorGetOutputTargetRect(This,pVideoProcessor,Enabled,pRect)
#define ID3D11VideoContext_VideoProcessorGetOutputBackgroundColor(This,pVideoProcessor,pYCbCr,pColor) (This)->lpVtbl->VideoProcessorGetOutputBackgroundColor(This,pVideoProcessor,pYCbCr,pColor)
#define ID3D11VideoContext_VideoProcessorGetOutputColorSpace(This,pVideoProcessor,pColorSpace) (This)->lpVtbl->VideoProcessorGetOutputColorSpace(This,pVideoProcessor,pColorSpace)
#define ID3D11VideoContext_VideoProcessorGetOutputAlphaFillMode(This,pVideoProcessor,pAlphaFillMode,pStreamIndex) (This)->lpVtbl->VideoProcessorGetOutputAlphaFillMode(This,pVideoProcessor,pAlphaFillMode,pStreamIndex)
#define ID3D11VideoContext_VideoProcessorGetOutputConstriction(This,pVideoProcessor,pEnabled,pSize) (This)->lpVtbl->VideoProcessorGetOutputConstriction(This,pVideoProcessor,pEnabled,pSize)
#define ID3D11VideoContext_VideoProcessorGetOutputStereoMode(This,pVideoProcessor,pEnabled) (This)->lpVtbl->VideoProcessorGetOutputStereoMode(This,pVideoProcessor,pEnabled)
#define ID3D11VideoContext_VideoProcessorGetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorGetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext_VideoProcessorSetStreamFrameFormat(This,pVideoProcessor,StreamIndex,FrameFormat) (This)->lpVtbl->VideoProcessorSetStreamFrameFormat(This,pVideoProcessor,StreamIndex,FrameFormat)
#define ID3D11VideoContext_VideoProcessorSetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace) (This)->lpVtbl->VideoProcessorSetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace)
#define ID3D11VideoContext_VideoProcessorSetStreamOutputRate(This,pVideoProcessor,StreamIndex,OutputRate,RepeatFrame,pCustomRate) (This)->lpVtbl->VideoProcessorSetStreamOutputRate(This,pVideoProcessor,StreamIndex,OutputRate,RepeatFrame,pCustomRate)
#define ID3D11VideoContext_VideoProcessorSetStreamSourceRect(This,pVideoProcessor,StreamIndex,Enable,pRect) (This)->lpVtbl->VideoProcessorSetStreamSourceRect(This,pVideoProcessor,StreamIndex,Enable,pRect)
#define ID3D11VideoContext_VideoProcessorSetStreamDestRect(This,pVideoProcessor,StreamIndex,Enable,pRect) (This)->lpVtbl->VideoProcessorSetStreamDestRect(This,pVideoProcessor,StreamIndex,Enable,pRect)
#define ID3D11VideoContext_VideoProcessorSetStreamAlpha(This,pVideoProcessor,StreamIndex,Enable,Alpha) (This)->lpVtbl->VideoProcessorSetStreamAlpha(This,pVideoProcessor,StreamIndex,Enable,Alpha)
#define ID3D11VideoContext_VideoProcessorSetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries) (This)->lpVtbl->VideoProcessorSetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries)
#define ID3D11VideoContext_VideoProcessorSetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,Enable,pSourceAspectRatio,pDestinationAspectRatio) (This)->lpVtbl->VideoProcessorSetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,Enable,pSourceAspectRatio,pDestinationAspectRatio)
#define ID3D11VideoContext_VideoProcessorSetStreamLumaKey(This,pVideoProcessor,StreamIndex,Enable,Lower,Upper) (This)->lpVtbl->VideoProcessorSetStreamLumaKey(This,pVideoProcessor,StreamIndex,Enable,Lower,Upper)
...
#define ID3D11VideoContext_VideoProcessorSetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,Enable) (This)->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,Enable)
#define ID3D11VideoContext_VideoProcessorSetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,Enable,Level) (This)->lpVtbl->VideoProcessorSetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,Enable,Level)
#define ID3D11VideoContext_VideoProcessorSetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorSetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext_VideoProcessorGetStreamFrameFormat(This,pVideoProcessor,StreamIndex,pFrameFormat) (This)->lpVtbl->VideoProcessorGetStreamFrameFormat(This,pVideoProcessor,StreamIndex,pFrameFormat)
#define ID3D11VideoContext_VideoProcessorGetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace) (This)->lpVtbl->VideoProcessorGetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace)
#define ID3D11VideoContext_VideoProcessorGetStreamOutputRate(This,pVideoProcessor,StreamIndex,pOutputRate,pRepeatFrame,pCustomRate) (This)->lpVtbl->VideoProcessorGetStreamOutputRate(This,pVideoProcessor,StreamIndex,pOutputRate,pRepeatFrame,pCustomRate)
#define ID3D11VideoContext_VideoProcessorGetStreamSourceRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect) (This)->lpVtbl->VideoProcessorGetStreamSourceRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect)
#define ID3D11VideoContext_VideoProcessorGetStreamDestRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect) (This)->lpVtbl->VideoProcessorGetStreamDestRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect)
#define ID3D11VideoContext_VideoProcessorGetStreamAlpha(This,pVideoProcessor,StreamIndex,pEnabled,pAlpha) (This)->lpVtbl->VideoProcessorGetStreamAlpha(This,pVideoProcessor,StreamIndex,pEnabled,pAlpha)
#define ID3D11VideoContext_VideoProcessorGetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries) (This)->lpVtbl->VideoProcessorGetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries)
#define ID3D11VideoContext_VideoProcessorGetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,pEnabled,pSourceAspectRatio,pDestinationAspectRatio) (This)->lpVtbl->VideoProcessorGetStreamPixelAspectRatio(This,pVideoProcessor,StreamIndex,pEnabled,pSourceAspectRatio,pDestinationAspectRatio)
#define ID3D11VideoContext_VideoProcessorGetStreamLumaKey(This,pVideoProcessor,StreamIndex,pEnabled,pLower,pUpper) (This)->lpVtbl->VideoProcessorGetStreamLumaKey(This,pVideoProcessor,StreamIndex,pEnabled,pLower,pUpper)
...
#define ID3D11VideoContext_VideoProcessorGetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,pEnabled) (This)->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,pEnabled)
#define ID3D11VideoContext_VideoProcessorGetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,pEnabled,pLevel) (This)->lpVtbl->VideoProcessorGetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,pEnabled,pLevel)
#define ID3D11VideoContext_VideoProcessorGetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData) (This)->lpVtbl->VideoProcessorGetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData)
#define ID3D11VideoContext_VideoProcessorBlt(This,pVideoProcessor,pView,OutputFrame,StreamCount,pStreams) (This)->lpVtbl->VideoProcessorBlt(This,pVideoProcessor,pView,OutputFrame,StreamCount,pStreams)
#define ID3D11VideoContext_NegotiateCryptoSessionKeyExchange(This,pCryptoSession,DataSize,pData) (This)->lpVtbl->NegotiateCryptoSessionKeyExchange(This,pCryptoSession,DataSize,pData)
#define ID3D11VideoContext_EncryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,IVSize,pIV) (This)->lpVtbl->EncryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,IVSize,pIV)
#define ID3D11VideoContext_DecryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,pEncryptedBlockInfo,ContentKeySize,pContentKey,IVSize,pIV) (This)->lpVtbl->DecryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,pEncryptedBlockInfo,ContentKeySize,pContentKey,IVSize,pIV)
#define ID3D11VideoContext_StartSessionKeyRefresh(This,pCryptoSession,RandomNumberSize,pRandomNumber) (This)->lpVtbl->StartSessionKeyRefresh(This,pCryptoSession,RandomNumberSize,pRandomNumber)
...
#define ID3D11VideoContext_GetEncryptionBltKey(This,pCryptoSession,KeySize,pReadbackKey) (This)->lpVtbl->GetEncryptionBltKey(This,pCryptoSession,KeySize,pReadbackKey)
#define ID3D11VideoContext_NegotiateAuthenticatedChannelKeyExchange(This,pChannel,DataSize,pData) (This)->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This,pChannel,DataSize,pData)
#define ID3D11VideoContext_QueryAuthenticatedChannel(This,pChannel,InputSize,pInput,OutputSize,pOutput) (This)->lpVtbl->QueryAuthenticatedChannel(This,pChannel,InputSize,pInput,OutputSize,pOutput)
#define ID3D11VideoContext_ConfigureAuthenticatedChannel(This,pChannel,InputSize,pInput,pOutput) (This)->lpVtbl->ConfigureAuthenticatedChannel(This,pChannel,InputSize,pInput,pOutput)
#define ID3D11VideoContext_VideoProcessorSetStreamRotation(This,pVideoProcessor,StreamIndex,Enable,Rotation) (This)->lpVtbl->VideoProcessorSetStreamRotation(This,pVideoProcessor,StreamIndex,Enable,Rotation)
#define ID3D11VideoContext_VideoProcessorGetStreamRotation(This,pVideoProcessor,StreamIndex,pEnable,pRotation) (This)->lpVtbl->VideoProcessorGetStreamRotation(This,pVideoProcessor,StreamIndex,pEnable,pRotation)
#else
/*** IUnknown methods ***/
...
/*** ID3D11VideoContext methods ***/
static FORCEINLINE HRESULT ID3D11VideoContext_GetDecoderBuffer(ID3D11VideoContext* This,ID3D11VideoDecoder *pDecoder,D3D11_VIDEO_DECODER_BUFFER_TYPE Type,UINT *pBufferSize,void **ppBuffer) {
    return This->lpVtbl->GetDecoderBuffer(This,pDecoder,Type,pBufferSize,ppBuffer);
}
static FORCEINLINE HRESULT ID3D11VideoContext_ReleaseDecoderBuffer(ID3D11VideoContext* This,ID3D11VideoDecoder *pDecoder,D3D11_VIDEO_DECODER_BUFFER_TYPE Type) {
    return This->lpVtbl->ReleaseDecoderBuffer(This,pDecoder,Type);
}
static FORCEINLINE HRESULT ID3D11VideoContext_DecoderBeginFrame(ID3D11VideoContext* This,ID3D11VideoDecoder *pDecoder,ID3D11VideoDecoderOutputView *pView,UINT ContentKeySize,const void *pContentKey) {
...
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext_DecoderExtension(ID3D11VideoContext* This,ID3D11VideoDecoder *pDecoder,const D3D11_VIDEO_DECODER_EXTENSION *pExtensionData) {
    return This->lpVtbl->DecoderExtension(This,pDecoder,pExtensionData);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetOutputTargetRect(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL Enable,const RECT *pRect) {
    This->lpVtbl->VideoProcessorSetOutputTargetRect(This,pVideoProcessor,Enable,pRect);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetOutputBackgroundColor(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL YCbCr,const D3D11_VIDEO_COLOR *pColor) {
    This->lpVtbl->VideoProcessorSetOutputBackgroundColor(This,pVideoProcessor,YCbCr,pColor);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetOutputColorSpace(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,const D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorSetOutputColorSpace(This,pVideoProcessor,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetOutputAlphaFillMode(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE AlphaFillMode,UINT StreamIndex) {
    This->lpVtbl->VideoProcessorSetOutputAlphaFillMode(This,pVideoProcessor,AlphaFillMode,StreamIndex);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetOutputConstriction(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL Enable,SIZE Size) {
    This->lpVtbl->VideoProcessorSetOutputConstriction(This,pVideoProcessor,Enable,Size);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetOutputStereoMode(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL Enable) {
    This->lpVtbl->VideoProcessorSetOutputStereoMode(This,pVideoProcessor,Enable);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext_VideoProcessorSetOutputExtension(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorSetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetOutputTargetRect(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *Enabled,RECT *pRect) {
    This->lpVtbl->VideoProcessorGetOutputTargetRect(This,pVideoProcessor,Enabled,pRect);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetOutputBackgroundColor(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pYCbCr,D3D11_VIDEO_COLOR *pColor) {
    This->lpVtbl->VideoProcessorGetOutputBackgroundColor(This,pVideoProcessor,pYCbCr,pColor);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetOutputColorSpace(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorGetOutputColorSpace(This,pVideoProcessor,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetOutputAlphaFillMode(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE *pAlphaFillMode,UINT *pStreamIndex) {
    This->lpVtbl->VideoProcessorGetOutputAlphaFillMode(This,pVideoProcessor,pAlphaFillMode,pStreamIndex);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetOutputConstriction(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pEnabled,SIZE *pSize) {
    This->lpVtbl->VideoProcessorGetOutputConstriction(This,pVideoProcessor,pEnabled,pSize);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetOutputStereoMode(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,BOOL *pEnabled) {
    This->lpVtbl->VideoProcessorGetOutputStereoMode(This,pVideoProcessor,pEnabled);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext_VideoProcessorGetOutputExtension(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorGetOutputExtension(This,pVideoProcessor,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamFrameFormat(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_FRAME_FORMAT FrameFormat) {
    This->lpVtbl->VideoProcessorSetStreamFrameFormat(This,pVideoProcessor,StreamIndex,FrameFormat);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamColorSpace(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,const D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorSetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamOutputRate(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_OUTPUT_RATE OutputRate,BOOL RepeatFrame,const DXGI_RATIONAL *pCustomRate) {
    This->lpVtbl->VideoProcessorSetStreamOutputRate(This,pVideoProcessor,StreamIndex,OutputRate,RepeatFrame,pCustomRate);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamSourceRect(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,const RECT *pRect) {
    This->lpVtbl->VideoProcessorSetStreamSourceRect(This,pVideoProcessor,StreamIndex,Enable,pRect);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamDestRect(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,const RECT *pRect) {
    This->lpVtbl->VideoProcessorSetStreamDestRect(This,pVideoProcessor,StreamIndex,Enable,pRect);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamAlpha(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,FLOAT Alpha) {
    This->lpVtbl->VideoProcessorSetStreamAlpha(This,pVideoProcessor,StreamIndex,Enable,Alpha);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamPalette(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,UINT Count,const UINT *pEntries) {
    This->lpVtbl->VideoProcessorSetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamPixelAspectRatio(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,const DXGI_RATIONAL *pSourceAspectRatio,const DXGI_RATIONAL *pDestinationAspectRatio) {
...
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamLumaKey(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,FLOAT Lower,FLOAT Upper) {
    This->lpVtbl->VideoProcessorSetStreamLumaKey(This,pVideoProcessor,StreamIndex,Enable,Lower,Upper);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamStereoFormat(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,D3D11_VIDEO_PROCESSOR_STEREO_FORMAT Format,BOOL LeftViewFrame0,BOOL BaseViewFrame0,D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE FlipMode,int MonoOffset) {
...
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamAutoProcessingMode(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable) {
    This->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,Enable);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamFilter(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_FILTER Filter,BOOL Enable,int Level) {
    This->lpVtbl->VideoProcessorSetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,Enable,Level);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext_VideoProcessorSetStreamExtension(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorSetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamFrameFormat(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_FRAME_FORMAT *pFrameFormat) {
    This->lpVtbl->VideoProcessorGetStreamFrameFormat(This,pVideoProcessor,StreamIndex,pFrameFormat);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamColorSpace(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_COLOR_SPACE *pColorSpace) {
    This->lpVtbl->VideoProcessorGetStreamColorSpace(This,pVideoProcessor,StreamIndex,pColorSpace);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamOutputRate(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_OUTPUT_RATE *pOutputRate,BOOL *pRepeatFrame,DXGI_RATIONAL *pCustomRate) {
    This->lpVtbl->VideoProcessorGetStreamOutputRate(This,pVideoProcessor,StreamIndex,pOutputRate,pRepeatFrame,pCustomRate);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamSourceRect(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,RECT *pRect) {
    This->lpVtbl->VideoProcessorGetStreamSourceRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamDestRect(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,RECT *pRect) {
    This->lpVtbl->VideoProcessorGetStreamDestRect(This,pVideoProcessor,StreamIndex,pEnabled,pRect);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamAlpha(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,FLOAT *pAlpha) {
    This->lpVtbl->VideoProcessorGetStreamAlpha(This,pVideoProcessor,StreamIndex,pEnabled,pAlpha);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamPalette(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,UINT Count,UINT *pEntries) {
    This->lpVtbl->VideoProcessorGetStreamPalette(This,pVideoProcessor,StreamIndex,Count,pEntries);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamPixelAspectRatio(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,DXGI_RATIONAL *pSourceAspectRatio,DXGI_RATIONAL *pDestinationAspectRatio) {
...
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamLumaKey(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled,FLOAT *pLower,FLOAT *pUpper) {
    This->lpVtbl->VideoProcessorGetStreamLumaKey(This,pVideoProcessor,StreamIndex,pEnabled,pLower,pUpper);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamStereoFormat(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnable,D3D11_VIDEO_PROCESSOR_STEREO_FORMAT *pFormat,BOOL *pLeftViewFrame0,BOOL *pBaseViewFrame0,D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE *pFlipMode,int *MonoOffset) {
...
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamAutoProcessingMode(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnabled) {
    This->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(This,pVideoProcessor,StreamIndex,pEnabled);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamFilter(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,D3D11_VIDEO_PROCESSOR_FILTER Filter,BOOL *pEnabled,int *pLevel) {
    This->lpVtbl->VideoProcessorGetStreamFilter(This,pVideoProcessor,StreamIndex,Filter,pEnabled,pLevel);
}
static FORCEINLINE APP_DEPRECATED_HRESULT ID3D11VideoContext_VideoProcessorGetStreamExtension(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,const GUID *pExtensionGuid,UINT DataSize,void *pData) {
    return This->lpVtbl->VideoProcessorGetStreamExtension(This,pVideoProcessor,StreamIndex,pExtensionGuid,DataSize,pData);
}
static FORCEINLINE HRESULT ID3D11VideoContext_VideoProcessorBlt(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,ID3D11VideoProcessorOutputView *pView,UINT OutputFrame,UINT StreamCount,const D3D11_VIDEO_PROCESSOR_STREAM *pStreams) {
    return This->lpVtbl->VideoProcessorBlt(This,pVideoProcessor,pView,OutputFrame,StreamCount,pStreams);
}
static FORCEINLINE HRESULT ID3D11VideoContext_NegotiateCryptoSessionKeyExchange(ID3D11VideoContext* This,ID3D11CryptoSession *pCryptoSession,UINT DataSize,void *pData) {
    return This->lpVtbl->NegotiateCryptoSessionKeyExchange(This,pCryptoSession,DataSize,pData);
}
static FORCEINLINE void ID3D11VideoContext_EncryptionBlt(ID3D11VideoContext* This,ID3D11CryptoSession *pCryptoSession,ID3D11Texture2D *pSrcSurface,ID3D11Texture2D *pDstSurface,UINT IVSize,void *pIV) {
    This->lpVtbl->EncryptionBlt(This,pCryptoSession,pSrcSurface,pDstSurface,IVSize,pIV);
}
static FORCEINLINE void ID3D11VideoContext_DecryptionBlt(ID3D11VideoContext* This,ID3D11CryptoSession *pCryptoSession,ID3D11Texture2D *pSrcSurface,ID3D11Texture2D *pDstSurface,D3D11_ENCRYPTED_BLOCK_INFO *pEncryptedBlockInfo,UINT ContentKeySize,const void *pContentKey,UINT IVSize,void *pIV) {
...
static FORCEINLINE void ID3D11VideoContext_StartSessionKeyRefresh(ID3D11VideoContext* This,ID3D11CryptoSession *pCryptoSession,UINT RandomNumberSize,void *pRandomNumber) {
    This->lpVtbl->StartSessionKeyRefresh(This,pCryptoSession,RandomNumberSize,pRandomNumber);
}
static FORCEINLINE void ID3D11VideoContext_FinishSessionKeyRefresh(ID3D11VideoContext* This,ID3D11CryptoSession *pCryptoSession) {
    This->lpVtbl->FinishSessionKeyRefresh(This,pCryptoSession);
}
static FORCEINLINE HRESULT ID3D11VideoContext_GetEncryptionBltKey(ID3D11VideoContext* This,ID3D11CryptoSession *pCryptoSession,UINT KeySize,void *pReadbackKey) {
    return This->lpVtbl->GetEncryptionBltKey(This,pCryptoSession,KeySize,pReadbackKey);
}
static FORCEINLINE HRESULT ID3D11VideoContext_NegotiateAuthenticatedChannelKeyExchange(ID3D11VideoContext* This,ID3D11AuthenticatedChannel *pChannel,UINT DataSize,void *pData) {
    return This->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This,pChannel,DataSize,pData);
}
static FORCEINLINE HRESULT ID3D11VideoContext_QueryAuthenticatedChannel(ID3D11VideoContext* This,ID3D11AuthenticatedChannel *pChannel,UINT InputSize,const void *pInput,UINT OutputSize,void *pOutput) {
    return This->lpVtbl->QueryAuthenticatedChannel(This,pChannel,InputSize,pInput,OutputSize,pOutput);
}
static FORCEINLINE HRESULT ID3D11VideoContext_ConfigureAuthenticatedChannel(ID3D11VideoContext* This,ID3D11AuthenticatedChannel *pChannel,UINT InputSize,const void *pInput,D3D11_AUTHENTICATED_CONFIGURE_OUTPUT *pOutput) {
    return This->lpVtbl->ConfigureAuthenticatedChannel(This,pChannel,InputSize,pInput,pOutput);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorSetStreamRotation(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL Enable,D3D11_VIDEO_PROCESSOR_ROTATION Rotation) {
    This->lpVtbl->VideoProcessorSetStreamRotation(This,pVideoProcessor,StreamIndex,Enable,Rotation);
}
static FORCEINLINE void ID3D11VideoContext_VideoProcessorGetStreamRotation(ID3D11VideoContext* This,ID3D11VideoProcessor *pVideoProcessor,UINT StreamIndex,BOOL *pEnable,D3D11_VIDEO_PROCESSOR_ROTATION *pRotation) {
