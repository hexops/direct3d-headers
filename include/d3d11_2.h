/*** Autogenerated by WIDL 5.0 from ./d3d11_2.idl - Do not edit ***/
...
/*** ID3D11DeviceContext2 methods ***/
#define ID3D11DeviceContext2_UpdateTileMappings(This,pTiledResource,NumTiledResourceRegions,pTiledResourceRegionStartCoordinates,pTiledResourceRegionSizes,pTilePool,NumRanges,pRangeFlags,pTilePoolStartOffsets,pRangeTileCounts,Flags) (This)->lpVtbl->UpdateTileMappings(This,pTiledResource,NumTiledResourceRegions,pTiledResourceRegionStartCoordinates,pTiledResourceRegionSizes,pTilePool,NumRanges,pRangeFlags,pTilePoolStartOffsets,pRangeTileCounts,Flags)
#define ID3D11DeviceContext2_CopyTileMappings(This,pDestTiledResource,pDestRegionStartCoordinate,pSourceTiledResource,pSourceRegionStartCoordinate,pTileRegionSize,Flags) (This)->lpVtbl->CopyTileMappings(This,pDestTiledResource,pDestRegionStartCoordinate,pSourceTiledResource,pSourceRegionStartCoordinate,pTileRegionSize,Flags)
#define ID3D11DeviceContext2_CopyTiles(This,pTiledResource,pTileRegionStartCoordinate,pTileRegionSize,pBuffer,BufferStartOffsetInBytes,Flags) (This)->lpVtbl->CopyTiles(This,pTiledResource,pTileRegionStartCoordinate,pTileRegionSize,pBuffer,BufferStartOffsetInBytes,Flags)
#define ID3D11DeviceContext2_UpdateTiles(This,pDestTiledResource,pDestTileRegionStartCoordinate,pDestTileRegionSize,pSourceTileData,Flags) (This)->lpVtbl->UpdateTiles(This,pDestTiledResource,pDestTileRegionStartCoordinate,pDestTileRegionSize,pSourceTileData,Flags)
#define ID3D11DeviceContext2_ResizeTilePool(This,pTilePool,NewSizeInBytes) (This)->lpVtbl->ResizeTilePool(This,pTilePool,NewSizeInBytes)
#define ID3D11DeviceContext2_TiledResourceBarrier(This,pTiledResourceOrViewAccessBeforeBarrier,pTiledResourceOrViewAccessAfterBarrier) (This)->lpVtbl->TiledResourceBarrier(This,pTiledResourceOrViewAccessBeforeBarrier,pTiledResourceOrViewAccessAfterBarrier)
#define ID3D11DeviceContext2_IsAnnotationEnabled(This) (This)->lpVtbl->IsAnnotationEnabled(This)
#define ID3D11DeviceContext2_SetMarkerInt(This,pLabel,Data) (This)->lpVtbl->SetMarkerInt(This,pLabel,Data)
#define ID3D11DeviceContext2_BeginEventInt(This,pLabel,Data) (This)->lpVtbl->BeginEventInt(This,pLabel,Data)
...
static FORCEINLINE void ID3D11DeviceContext2_CopyTiles(ID3D11DeviceContext2* This,ID3D11Resource *pTiledResource,const D3D11_TILED_RESOURCE_COORDINATE *pTileRegionStartCoordinate,const D3D11_TILE_REGION_SIZE *pTileRegionSize,ID3D11Buffer *pBuffer,UINT64 BufferStartOffsetInBytes,UINT Flags) {
...
static FORCEINLINE void ID3D11DeviceContext2_UpdateTiles(ID3D11DeviceContext2* This,ID3D11Resource *pDestTiledResource,const D3D11_TILED_RESOURCE_COORDINATE *pDestTileRegionStartCoordinate,const D3D11_TILE_REGION_SIZE *pDestTileRegionSize,const void *pSourceTileData,UINT Flags) {
    This->lpVtbl->UpdateTiles(This,pDestTiledResource,pDestTileRegionStartCoordinate,pDestTileRegionSize,pSourceTileData,Flags);
}
static FORCEINLINE HRESULT ID3D11DeviceContext2_ResizeTilePool(ID3D11DeviceContext2* This,ID3D11Buffer *pTilePool,UINT64 NewSizeInBytes) {
    return This->lpVtbl->ResizeTilePool(This,pTilePool,NewSizeInBytes);
}
static FORCEINLINE void ID3D11DeviceContext2_TiledResourceBarrier(ID3D11DeviceContext2* This,ID3D11DeviceChild *pTiledResourceOrViewAccessBeforeBarrier,ID3D11DeviceChild *pTiledResourceOrViewAccessAfterBarrier) {
...
static FORCEINLINE void ID3D11DeviceContext2_SetMarkerInt(ID3D11DeviceContext2* This,LPCWSTR pLabel,INT Data) {
    This->lpVtbl->SetMarkerInt(This,pLabel,Data);
}
static FORCEINLINE void ID3D11DeviceContext2_BeginEventInt(ID3D11DeviceContext2* This,LPCWSTR pLabel,INT Data) {
...
/*** ID3D11Device2 methods ***/
#define ID3D11Device2_GetImmediateContext2(This,ppImmediateContext) (This)->lpVtbl->GetImmediateContext2(This,ppImmediateContext)
#define ID3D11Device2_CreateDeferredContext2(This,ContextFlags,ppDeferredContext) (This)->lpVtbl->CreateDeferredContext2(This,ContextFlags,ppDeferredContext)
#define ID3D11Device2_GetResourceTiling(This,pTiledResource,pNumTilesForEntireResource,pPackedMipDesc,pStandardTileShapeForNonPackedMips,pNumSubresourceTilings,FirstSubresourceTilingToGet,pSubresourceTilingsForNonPackedMips) (This)->lpVtbl->GetResourceTiling(This,pTiledResource,pNumTilesForEntireResource,pPackedMipDesc,pStandardTileShapeForNonPackedMips,pNumSubresourceTilings,FirstSubresourceTilingToGet,pSubresourceTilingsForNonPackedMips)
#define ID3D11Device2_CheckMultisampleQualityLevels1(This,Format,SampleCount,Flags,pNumQualityLevels) (This)->lpVtbl->CheckMultisampleQualityLevels1(This,Format,SampleCount,Flags,pNumQualityLevels)
#else
/*** IUnknown methods ***/
...
/*** ID3D11Device2 methods ***/
static FORCEINLINE void ID3D11Device2_GetImmediateContext2(ID3D11Device2* This,ID3D11DeviceContext2 **ppImmediateContext) {
    This->lpVtbl->GetImmediateContext2(This,ppImmediateContext);
}
static FORCEINLINE HRESULT ID3D11Device2_CreateDeferredContext2(ID3D11Device2* This,UINT ContextFlags,ID3D11DeviceContext2 **ppDeferredContext) {
    return This->lpVtbl->CreateDeferredContext2(This,ContextFlags,ppDeferredContext);
}
static FORCEINLINE void ID3D11Device2_GetResourceTiling(ID3D11Device2* This,ID3D11Resource *pTiledResource,UINT *pNumTilesForEntireResource,D3D11_PACKED_MIP_DESC *pPackedMipDesc,D3D11_TILE_SHAPE *pStandardTileShapeForNonPackedMips,UINT *pNumSubresourceTilings,UINT FirstSubresourceTilingToGet,D3D11_SUBRESOURCE_TILING *pSubresourceTilingsForNonPackedMips) {
...
static FORCEINLINE HRESULT ID3D11Device2_CheckMultisampleQualityLevels1(ID3D11Device2* This,DXGI_FORMAT Format,UINT SampleCount,UINT Flags,UINT *pNumQualityLevels) {
