/*** Autogenerated by WIDL 5.0 from ./d3d11sdklayers.idl - Do not edit ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11TracingDevice, 0x1911c771, 0x1587, 0x413e, 0xa7,0xe0, 0xfb,0x26,0xc3,0xde,0x02,0x68)
#endif
#else
...
interface ID3D11TracingDevice {
    CONST_VTBL ID3D11TracingDeviceVtbl* lpVtbl;
};
...
/*** ID3D11TracingDevice methods ***/
#define ID3D11TracingDevice_SetShaderTrackingOptionsByType(This,ResourceTypeFlags,Options) (This)->lpVtbl->SetShaderTrackingOptionsByType(This,ResourceTypeFlags,Options)
#define ID3D11TracingDevice_SetShaderTrackingOptions(This,pShader,Options) (This)->lpVtbl->SetShaderTrackingOptions(This,pShader,Options)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID3D11TracingDevice_QueryInterface(ID3D11TracingDevice* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID3D11TracingDevice_AddRef(ID3D11TracingDevice* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID3D11TracingDevice_Release(ID3D11TracingDevice* This) {
    return This->lpVtbl->Release(This);
}
/*** ID3D11TracingDevice methods ***/
static FORCEINLINE HRESULT ID3D11TracingDevice_SetShaderTrackingOptionsByType(ID3D11TracingDevice* This,UINT ResourceTypeFlags,UINT Options) {
    return This->lpVtbl->SetShaderTrackingOptionsByType(This,ResourceTypeFlags,Options);
}
static FORCEINLINE HRESULT ID3D11TracingDevice_SetShaderTrackingOptions(ID3D11TracingDevice* This,IUnknown *pShader,UINT Options) {
    return This->lpVtbl->SetShaderTrackingOptions(This,pShader,Options);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11RefTrackingOptions, 0x193dacdf, 0x0db2, 0x4c05, 0xa5,0x5c, 0xef,0x06,0xca,0xc5,0x6f,0xd9)
#endif
#else
typedef struct ID3D11RefTrackingOptionsVtbl {
    ...
    /*** ID3D11RefTrackingOptions methods ***/
...
interface ID3D11RefTrackingOptions {
    CONST_VTBL ID3D11RefTrackingOptionsVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID3D11RefTrackingOptions_QueryInterface(ID3D11RefTrackingOptions* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID3D11RefTrackingOptions_AddRef(ID3D11RefTrackingOptions* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID3D11RefTrackingOptions_Release(ID3D11RefTrackingOptions* This) {
    return This->lpVtbl->Release(This);
}
/*** ID3D11RefTrackingOptions methods ***/
static FORCEINLINE HRESULT ID3D11RefTrackingOptions_SetTrackingOptions(ID3D11RefTrackingOptions* This,UINT uOptions) {
    return This->lpVtbl->SetTrackingOptions(This,uOptions);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11RefDefaultTrackingOptions, 0x03916615, 0xc644, 0x418c, 0x9b,0xf4, 0x75,0xdb,0x5b,0xe6,0x3c,0xa0)
#endif
#else
typedef struct ID3D11RefDefaultTrackingOptionsVtbl {
    ...
    /*** ID3D11RefDefaultTrackingOptions methods ***/
    HRESULT (STDMETHODCALLTYPE *SetTrackingOptions)(
        ID3D11RefDefaultTrackingOptions *This,
        UINT ResourceTypeFlags,
        UINT Options);
...
interface ID3D11RefDefaultTrackingOptions {
    CONST_VTBL ID3D11RefDefaultTrackingOptionsVtbl* lpVtbl;
};
...
/*** ID3D11RefDefaultTrackingOptions methods ***/
#define ID3D11RefDefaultTrackingOptions_SetTrackingOptions(This,ResourceTypeFlags,Options) (This)->lpVtbl->SetTrackingOptions(This,ResourceTypeFlags,Options)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID3D11RefDefaultTrackingOptions_QueryInterface(ID3D11RefDefaultTrackingOptions* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID3D11RefDefaultTrackingOptions_AddRef(ID3D11RefDefaultTrackingOptions* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID3D11RefDefaultTrackingOptions_Release(ID3D11RefDefaultTrackingOptions* This) {
    return This->lpVtbl->Release(This);
}
/*** ID3D11RefDefaultTrackingOptions methods ***/
static FORCEINLINE HRESULT ID3D11RefDefaultTrackingOptions_SetTrackingOptions(ID3D11RefDefaultTrackingOptions* This,UINT ResourceTypeFlags,UINT Options) {
    return This->lpVtbl->SetTrackingOptions(This,ResourceTypeFlags,Options);
}
#endif
#endif
...
typedef enum D3D11_MESSAGE_ID {
    ...
    D3D11_MESSAGE_ID_USE_OF_ZERO_REFCOUNT_OBJECT = 0x20010f,
    D3D11_MESSAGE_ID_D3D11_MESSAGES_END = 0x200110,
    ...
    D3D11_MESSAGE_ID_GETDATAFORNEWHARDWAREKEY_NULLPARAM = 0x300164,
    D3D11_MESSAGE_ID_CHECKCRYPTOSESSIONSTATUS_NULLPARAM = 0x300165,
    D3D11_MESSAGE_ID_GETCRYPTOSESSIONPRIVATEDATASIZE_NULLPARAM = 0x300166,
    D3D11_MESSAGE_ID_GETVIDEODECODERCAPS_NULLPARAM = 0x300167,
    D3D11_MESSAGE_ID_GETVIDEODECODERCAPS_ZEROWIDTHHEIGHT = 0x300168,
    D3D11_MESSAGE_ID_CHECKVIDEODECODERDOWNSAMPLING_NULLPARAM = 0x300169,
    D3D11_MESSAGE_ID_CHECKVIDEODECODERDOWNSAMPLING_INVALIDCOLORSPACE = 0x30016a,
    D3D11_MESSAGE_ID_CHECKVIDEODECODERDOWNSAMPLING_ZEROWIDTHHEIGHT = 0x30016b,
    D3D11_MESSAGE_ID_VIDEODECODERENABLEDOWNSAMPLING_NULLPARAM = 0x30016c,
    D3D11_MESSAGE_ID_VIDEODECODERENABLEDOWNSAMPLING_UNSUPPORTED = 0x30016d,
    D3D11_MESSAGE_ID_VIDEODECODERUPDATEDOWNSAMPLING_NULLPARAM = 0x30016e,
    D3D11_MESSAGE_ID_VIDEODECODERUPDATEDOWNSAMPLING_UNSUPPORTED = 0x30016f,
    D3D11_MESSAGE_ID_CHECKVIDEOPROCESSORFORMATCONVERSION_NULLPARAM = 0x300170,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTCOLORSPACE1_NULLPARAM = 0x300171,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTCOLORSPACE1_NULLPARAM = 0x300172,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMCOLORSPACE1_NULLPARAM = 0x300173,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMCOLORSPACE1_INVALIDSTREAM = 0x300174,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMMIRROR_NULLPARAM = 0x300175,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMMIRROR_INVALIDSTREAM = 0x300176,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMMIRROR_UNSUPPORTED = 0x300177,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMCOLORSPACE1_NULLPARAM = 0x300178,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMMIRROR_NULLPARAM = 0x300179,
    D3D11_MESSAGE_ID_RECOMMENDVIDEODECODERDOWNSAMPLING_NULLPARAM = 0x30017a,
    D3D11_MESSAGE_ID_RECOMMENDVIDEODECODERDOWNSAMPLING_INVALIDCOLORSPACE = 0x30017b,
    D3D11_MESSAGE_ID_RECOMMENDVIDEODECODERDOWNSAMPLING_ZEROWIDTHHEIGHT = 0x30017c,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTSHADERUSAGE_NULLPARAM = 0x30017d,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTSHADERUSAGE_NULLPARAM = 0x30017e,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETBEHAVIORHINTS_NULLPARAM = 0x30017f,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETBEHAVIORHINTS_INVALIDSTREAMCOUNT = 0x300180,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETBEHAVIORHINTS_TARGETRECT = 0x300181,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETBEHAVIORHINTS_INVALIDSOURCERECT = 0x300182,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETBEHAVIORHINTS_INVALIDDESTRECT = 0x300183,
    D3D11_MESSAGE_ID_GETCRYPTOSESSIONPRIVATEDATASIZE_INVALID_KEY_EXCHANGE_TYPE = 0x300184,
    D3D11_MESSAGE_ID_D3D11_1_MESSAGES_END = 0x300185,
    D3D11_MESSAGE_ID_D3D11_2_MESSAGES_START = 0x300186,
    D3D11_MESSAGE_ID_CREATEBUFFER_INVALIDUSAGE = 0x300187,
    D3D11_MESSAGE_ID_CREATETEXTURE1D_INVALIDUSAGE = 0x300188,
    D3D11_MESSAGE_ID_CREATETEXTURE2D_INVALIDUSAGE = 0x300189,
    D3D11_MESSAGE_ID_CREATEINPUTLAYOUT_LEVEL9_STEPRATE_NOT_1 = 0x30018a,
    D3D11_MESSAGE_ID_CREATEINPUTLAYOUT_LEVEL9_INSTANCING_NOT_SUPPORTED = 0x30018b,
    D3D11_MESSAGE_ID_UPDATETILEMAPPINGS_INVALID_PARAMETER = 0x30018c,
    D3D11_MESSAGE_ID_COPYTILEMAPPINGS_INVALID_PARAMETER = 0x30018d,
    D3D11_MESSAGE_ID_COPYTILES_INVALID_PARAMETER = 0x30018e,
    D3D11_MESSAGE_ID_UPDATETILES_INVALID_PARAMETER = 0x30018f,
    D3D11_MESSAGE_ID_RESIZETILEPOOL_INVALID_PARAMETER = 0x300190,
    D3D11_MESSAGE_ID_TILEDRESOURCEBARRIER_INVALID_PARAMETER = 0x300191,
    D3D11_MESSAGE_ID_NULL_TILE_MAPPING_ACCESS_WARNING = 0x300192,
    D3D11_MESSAGE_ID_NULL_TILE_MAPPING_ACCESS_ERROR = 0x300193,
    D3D11_MESSAGE_ID_DIRTY_TILE_MAPPING_ACCESS = 0x300194,
    D3D11_MESSAGE_ID_DUPLICATE_TILE_MAPPINGS_IN_COVERED_AREA = 0x300195,
    D3D11_MESSAGE_ID_TILE_MAPPINGS_IN_COVERED_AREA_DUPLICATED_OUTSIDE = 0x300196,
    D3D11_MESSAGE_ID_TILE_MAPPINGS_SHARED_BETWEEN_INCOMPATIBLE_RESOURCES = 0x300197,
    D3D11_MESSAGE_ID_TILE_MAPPINGS_SHARED_BETWEEN_INPUT_AND_OUTPUT = 0x300198,
    D3D11_MESSAGE_ID_CHECKMULTISAMPLEQUALITYLEVELS_INVALIDFLAGS = 0x300199,
    D3D11_MESSAGE_ID_GETRESOURCETILING_NONTILED_RESOURCE = 0x30019a,
    D3D11_MESSAGE_ID_RESIZETILEPOOL_SHRINK_WITH_MAPPINGS_STILL_DEFINED_PAST_END = 0x30019b,
    D3D11_MESSAGE_ID_NEED_TO_CALL_TILEDRESOURCEBARRIER = 0x30019c,
    D3D11_MESSAGE_ID_CREATEDEVICE_INVALIDARGS = 0x30019d,
    D3D11_MESSAGE_ID_CREATEDEVICE_WARNING = 0x30019e,
    D3D11_MESSAGE_ID_CLEARUNORDEREDACCESSVIEWUINT_HAZARD = 0x30019f,
    D3D11_MESSAGE_ID_CLEARUNORDEREDACCESSVIEWFLOAT_HAZARD = 0x3001a0,
    D3D11_MESSAGE_ID_TILED_RESOURCE_TIER_1_BUFFER_TEXTURE_MISMATCH = 0x3001a1,
    D3D11_MESSAGE_ID_CREATE_CRYPTOSESSION = 0x3001a2,
    D3D11_MESSAGE_ID_CREATE_AUTHENTICATEDCHANNEL = 0x3001a3,
    D3D11_MESSAGE_ID_LIVE_CRYPTOSESSION = 0x3001a4,
    D3D11_MESSAGE_ID_LIVE_AUTHENTICATEDCHANNEL = 0x3001a5,
    D3D11_MESSAGE_ID_DESTROY_CRYPTOSESSION = 0x3001a6,
    D3D11_MESSAGE_ID_DESTROY_AUTHENTICATEDCHANNEL = 0x3001a7,
    D3D11_MESSAGE_ID_D3D11_2_MESSAGES_END = 0x3001a8,
    D3D11_MESSAGE_ID_D3D11_3_MESSAGES_START = 0x3001a9,
    D3D11_MESSAGE_ID_CREATERASTERIZERSTATE_INVALID_CONSERVATIVERASTERMODE = 0x3001aa,
    D3D11_MESSAGE_ID_DEVICE_DRAW_INVALID_SYSTEMVALUE = 0x3001ab,
    D3D11_MESSAGE_ID_CREATEQUERYORPREDICATE_INVALIDCONTEXTTYPE = 0x3001ac,
    D3D11_MESSAGE_ID_CREATEQUERYORPREDICATE_DECODENOTSUPPORTED = 0x3001ad,
    D3D11_MESSAGE_ID_CREATEQUERYORPREDICATE_ENCODENOTSUPPORTED = 0x3001ae,
    D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_INVALIDPLANEINDEX = 0x3001af,
    D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_INVALIDVIDEOPLANEINDEX = 0x3001b0,
    D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_AMBIGUOUSVIDEOPLANEINDEX = 0x3001b1,
    D3D11_MESSAGE_ID_CREATERENDERTARGETVIEW_INVALIDPLANEINDEX = 0x3001b2,
    D3D11_MESSAGE_ID_CREATERENDERTARGETVIEW_INVALIDVIDEOPLANEINDEX = 0x3001b3,
    D3D11_MESSAGE_ID_CREATERENDERTARGETVIEW_AMBIGUOUSVIDEOPLANEINDEX = 0x3001b4,
    D3D11_MESSAGE_ID_CREATEUNORDEREDACCESSVIEW_INVALIDPLANEINDEX = 0x3001b5,
    D3D11_MESSAGE_ID_CREATEUNORDEREDACCESSVIEW_INVALIDVIDEOPLANEINDEX = 0x3001b6,
    D3D11_MESSAGE_ID_CREATEUNORDEREDACCESSVIEW_AMBIGUOUSVIDEOPLANEINDEX = 0x3001b7,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDSCANDATAOFFSET = 0x3001b8,
    D3D11_MESSAGE_ID_JPEGDECODE_NOTSUPPORTED = 0x3001b9,
    D3D11_MESSAGE_ID_JPEGDECODE_DIMENSIONSTOOLARGE = 0x3001ba,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDCOMPONENTS = 0x3001bb,
    D3D11_MESSAGE_ID_JPEGDECODE_DESTINATIONNOT2D = 0x3001bc,
    D3D11_MESSAGE_ID_JPEGDECODE_TILEDRESOURCESUNSUPPORTED = 0x3001bd,
    D3D11_MESSAGE_ID_JPEGDECODE_GUARDRECTSUNSUPPORTED = 0x3001be,
    D3D11_MESSAGE_ID_JPEGDECODE_FORMATUNSUPPORTED = 0x3001bf,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDSUBRESOURCE = 0x3001c0,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDMIPLEVEL = 0x3001c1,
    D3D11_MESSAGE_ID_JPEGDECODE_EMPTYDESTBOX = 0x3001c2,
    D3D11_MESSAGE_ID_JPEGDECODE_DESTBOXNOT2D = 0x3001c3,
    D3D11_MESSAGE_ID_JPEGDECODE_DESTBOXNOTSUB = 0x3001c4,
    D3D11_MESSAGE_ID_JPEGDECODE_DESTBOXESINTERSECT = 0x3001c5,
    D3D11_MESSAGE_ID_JPEGDECODE_XSUBSAMPLEMISMATCH = 0x3001c6,
    D3D11_MESSAGE_ID_JPEGDECODE_YSUBSAMPLEMISMATCH = 0x3001c7,
    D3D11_MESSAGE_ID_JPEGDECODE_XSUBSAMPLEODD = 0x3001c8,
    D3D11_MESSAGE_ID_JPEGDECODE_YSUBSAMPLEODD = 0x3001c9,
    D3D11_MESSAGE_ID_JPEGDECODE_OUTPUTDIMENSIONSTOOLARGE = 0x3001ca,
    D3D11_MESSAGE_ID_JPEGDECODE_NONPOW2SCALEUNSUPPORTED = 0x3001cb,
    D3D11_MESSAGE_ID_JPEGDECODE_FRACTIONALDOWNSCALETOLARGE = 0x3001cc,
    D3D11_MESSAGE_ID_JPEGDECODE_CHROMASIZEMISMATCH = 0x3001cd,
    D3D11_MESSAGE_ID_JPEGDECODE_LUMACHROMASIZEMISMATCH = 0x3001ce,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDNUMDESTINATIONS = 0x3001cf,
    D3D11_MESSAGE_ID_JPEGDECODE_SUBBOXUNSUPPORTED = 0x3001d0,
    D3D11_MESSAGE_ID_JPEGDECODE_1DESTUNSUPPORTEDFORMAT = 0x3001d1,
    D3D11_MESSAGE_ID_JPEGDECODE_3DESTUNSUPPORTEDFORMAT = 0x3001d2,
    D3D11_MESSAGE_ID_JPEGDECODE_SCALEUNSUPPORTED = 0x3001d3,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDSOURCESIZE = 0x3001d4,
    D3D11_MESSAGE_ID_JPEGDECODE_INVALIDCOPYFLAGS = 0x3001d5,
    D3D11_MESSAGE_ID_JPEGDECODE_HAZARD = 0x3001d6,
    D3D11_MESSAGE_ID_JPEGDECODE_UNSUPPORTEDSRCBUFFERUSAGE = 0x3001d7,
    D3D11_MESSAGE_ID_JPEGDECODE_UNSUPPORTEDSRCBUFFERMISCFLAGS = 0x3001d8,
    D3D11_MESSAGE_ID_JPEGDECODE_UNSUPPORTEDDSTTEXTUREUSAGE = 0x3001d9,
    D3D11_MESSAGE_ID_JPEGDECODE_BACKBUFFERNOTSUPPORTED = 0x3001da,
    D3D11_MESSAGE_ID_JPEGDECODE_UNSUPPRTEDCOPYFLAGS = 0x3001db,
    D3D11_MESSAGE_ID_JPEGENCODE_NOTSUPPORTED = 0x3001dc,
    D3D11_MESSAGE_ID_JPEGENCODE_INVALIDSCANDATAOFFSET = 0x3001dd,
    D3D11_MESSAGE_ID_JPEGENCODE_INVALIDCOMPONENTS = 0x3001de,
    D3D11_MESSAGE_ID_JPEGENCODE_SOURCENOT2D = 0x3001df,
    D3D11_MESSAGE_ID_JPEGENCODE_TILEDRESOURCESUNSUPPORTED = 0x3001e0,
    D3D11_MESSAGE_ID_JPEGENCODE_GUARDRECTSUNSUPPORTED = 0x3001e1,
    D3D11_MESSAGE_ID_JPEGENCODE_XSUBSAMPLEMISMATCH = 0x3001e2,
    D3D11_MESSAGE_ID_JPEGENCODE_YSUBSAMPLEMISMATCH = 0x3001e3,
    D3D11_MESSAGE_ID_JPEGENCODE_FORMATUNSUPPORTED = 0x3001e4,
    D3D11_MESSAGE_ID_JPEGENCODE_INVALIDSUBRESOURCE = 0x3001e5,
    D3D11_MESSAGE_ID_JPEGENCODE_INVALIDMIPLEVEL = 0x3001e6,
    D3D11_MESSAGE_ID_JPEGENCODE_DIMENSIONSTOOLARGE = 0x3001e7,
    D3D11_MESSAGE_ID_JPEGENCODE_HAZARD = 0x3001e8,
    D3D11_MESSAGE_ID_JPEGENCODE_UNSUPPORTEDDSTBUFFERUSAGE = 0x3001e9,
    D3D11_MESSAGE_ID_JPEGENCODE_UNSUPPORTEDDSTBUFFERMISCFLAGS = 0x3001ea,
    D3D11_MESSAGE_ID_JPEGENCODE_UNSUPPORTEDSRCTEXTUREUSAGE = 0x3001eb,
    D3D11_MESSAGE_ID_JPEGENCODE_BACKBUFFERNOTSUPPORTED = 0x3001ec,
    D3D11_MESSAGE_ID_CREATEQUERYORPREDICATE_UNSUPPORTEDCONTEXTTTYPEFORQUERY = 0x3001ed,
    D3D11_MESSAGE_ID_FLUSH1_INVALIDCONTEXTTYPE = 0x3001ee,
    D3D11_MESSAGE_ID_DEVICE_SETHARDWAREPROTECTION_INVALIDCONTEXT = 0x3001ef,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTHDRMETADATA_NULLPARAM = 0x3001f0,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTHDRMETADATA_INVALIDSIZE = 0x3001f1,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTHDRMETADATA_NULLPARAM = 0x3001f2,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTHDRMETADATA_INVALIDSIZE = 0x3001f3,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMHDRMETADATA_NULLPARAM = 0x3001f4,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMHDRMETADATA_INVALIDSTREAM = 0x3001f5,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMHDRMETADATA_INVALIDSIZE = 0x3001f6,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMHDRMETADATA_NULLPARAM = 0x3001f7,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMHDRMETADATA_INVALIDSTREAM = 0x3001f8,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMHDRMETADATA_INVALIDSIZE = 0x3001f9,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMFRAMEFORMAT_INVALIDSTREAM = 0x3001fa,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMCOLORSPACE_INVALIDSTREAM = 0x3001fb,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMOUTPUTRATE_INVALIDSTREAM = 0x3001fc,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMSOURCERECT_INVALIDSTREAM = 0x3001fd,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMDESTRECT_INVALIDSTREAM = 0x3001fe,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMALPHA_INVALIDSTREAM = 0x3001ff,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMPALETTE_INVALIDSTREAM = 0x300200,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMPIXELASPECTRATIO_INVALIDSTREAM = 0x300201,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMLUMAKEY_INVALIDSTREAM = 0x300202,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMSTEREOFORMAT_INVALIDSTREAM = 0x300203,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMAUTOPROCESSINGMODE_INVALIDSTREAM = 0x300204,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMFILTER_INVALIDSTREAM = 0x300205,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMROTATION_INVALIDSTREAM = 0x300206,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMCOLORSPACE1_INVALIDSTREAM = 0x300207,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMMIRROR_INVALIDSTREAM = 0x300208,
    D3D11_MESSAGE_ID_CREATE_FENCE = 0x300209,
    D3D11_MESSAGE_ID_LIVE_FENCE = 0x30020a,
    D3D11_MESSAGE_ID_DESTROY_FENCE = 0x30020b,
    D3D11_MESSAGE_ID_CREATE_SYNCHRONIZEDCHANNEL = 0x30020c,
    D3D11_MESSAGE_ID_LIVE_SYNCHRONIZEDCHANNEL = 0x30020d,
    D3D11_MESSAGE_ID_DESTROY_SYNCHRONIZEDCHANNEL = 0x30020e,
    D3D11_MESSAGE_ID_CREATEFENCE_INVALIDFLAGS = 0x30020f,
    D3D11_MESSAGE_ID_D3D11_3_MESSAGES_END = 0x300210,
    D3D11_MESSAGE_ID_D3D11_5_MESSAGES_START = 0x300211,
    D3D11_MESSAGE_ID_NEGOTIATECRYPTOSESSIONKEYEXCHANGEMT_INVALIDKEYEXCHANGETYPE = 0x300212,
    D3D11_MESSAGE_ID_NEGOTIATECRYPTOSESSIONKEYEXCHANGEMT_NOT_SUPPORTED = 0x300213,
    D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_COMPONENT_COUNT = 0x300214,
    D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_COMPONENT = 0x300215,
    D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_SIZE = 0x300216,
    D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_USAGE = 0x300217,
    D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_MISC_FLAGS = 0x300218,
    D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_OFFSET = 0x300219,
    D3D11_MESSAGE_ID_CREATE_TRACKEDWORKLOAD = 0x30021a,
    D3D11_MESSAGE_ID_LIVE_TRACKEDWORKLOAD = 0x30021b,
    D3D11_MESSAGE_ID_DESTROY_TRACKEDWORKLOAD = 0x30021c,
    D3D11_MESSAGE_ID_CREATE_TRACKED_WORKLOAD_NULLPARAM = 0x30021d,
    D3D11_MESSAGE_ID_CREATE_TRACKED_WORKLOAD_INVALID_MAX_INSTANCES = 0x30021e,
    D3D11_MESSAGE_ID_CREATE_TRACKED_WORKLOAD_INVALID_DEADLINE_TYPE = 0x30021f,
    D3D11_MESSAGE_ID_CREATE_TRACKED_WORKLOAD_INVALID_ENGINE_TYPE = 0x300220,
    D3D11_MESSAGE_ID_MULTIPLE_TRACKED_WORKLOADS = 0x300221,
    D3D11_MESSAGE_ID_MULTIPLE_TRACKED_WORKLOAD_PAIRS = 0x300222,
    D3D11_MESSAGE_ID_INCOMPLETE_TRACKED_WORKLOAD_PAIR = 0x300223,
    D3D11_MESSAGE_ID_OUT_OF_ORDER_TRACKED_WORKLOAD_PAIR = 0x300224,
    D3D11_MESSAGE_ID_CANNOT_ADD_TRACKED_WORKLOAD = 0x300225,
    D3D11_MESSAGE_ID_TRACKED_WORKLOAD_NOT_SUPPORTED = 0x300226,
    D3D11_MESSAGE_ID_TRACKED_WORKLOAD_ENGINE_TYPE_NOT_FOUND = 0x300227,
    D3D11_MESSAGE_ID_NO_TRACKED_WORKLOAD_SLOT_AVAILABLE = 0x300228,
    D3D11_MESSAGE_ID_END_TRACKED_WORKLOAD_INVALID_ARG = 0x300229,
    D3D11_MESSAGE_ID_TRACKED_WORKLOAD_DISJOINT_FAILURE = 0x30022a,
    D3D11_MESSAGE_ID_D3D11_5_MESSAGES_END = 0x30022b
} D3D11_MESSAGE_ID;
